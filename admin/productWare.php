...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['submit'])) {
    $updateProduct = $product->update_product1($_POST, $_FILES, $id);
}
?>
        ...
        <div class="block">
            ...
            ?>
                    ...
                    <tr>
                        ...
                        <td>
                            <input id="qty" value="<?php echo $productDetail['qty'] ?>" name="qty" type="text" placeholder="Enter Interest..." class="medium" />
                        </td>
                    </tr>
                    <tr>
                        <td>
