...
public class ThongKeSP extends javax.swing.JFrame {
    ...
    public ThongKeSP() throws SQLException {
        initComponents();
         buss = new Buss();
...
//        dskh = ConnectSQL.getKhachHangs();
        ...
        ds = buss.getTop_sanphams();
        tablemodel.setRowCount(0);
        int i = 1;
        String gioitinh;
        int sum = 0;
        int sl = 0;
        for (top_sanpham hd : ds) {
            Vector vctData = new Vector();
//            vctData.add(i);
            i++;
            vctData.add(hd.getSanphamID());
            vctData.add(hd.getSoluong());
            vctData.add(hd.getNgay());
            vctData.add(hd.getThanhtien());
            sl+=Integer.parseInt(hd.getSoluong());
            if(hd.getThanhtien()!=null && !hd.getThanhtien().equalsIgnoreCase("") && Integer.parseInt(hd.getThanhtien()) >=0)
            sum+=Integer.parseInt(hd.getThanhtien());
            tablemodel.addRow(vctData);

        }
        i--;
    jTextField_TrenB.setText(""+i);
    jTextField2.setText(""+sl);
    jTextField3.setText(""+sum);

    }
    private void loadData(ArrayList<top_sanpham> ds) {   
//     
        tablemodel.setRowCount(0);
        int i = 1;
        String gioitinh;
...
//            vctData.add(i);
    ...
    private void initComponents() {
        ...
        jComboBox_HienSanPham = new javax.swing.JComboBox<>();
        ...
        jLabel12.setText("Thống kê sản phẩm bán chạy nhất");
                ...
                .addGroup(jPanel23Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel23Layout.createSequentialGroup()
                        .addGroup(jPanel23Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(jDateChooser_TuNgay, javax.swing.GroupLayout.PREFERRED_SIZE, 34, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jLabel16.setText("Hiện Thị :");

        jComboBox_HienSanPham.setBackground(new java.awt.Color(252, 252, 252));
        jComboBox_HienSanPham.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        jComboBox_HienSanPham.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Top 3", "Top 5", " " }));
        ...
        jPanel24Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel24Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addComponent(jComboBox_HienSanPham, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                ...
                .addComponent(jButton_PDF, javax.swing.GroupLayout.PREFERRED_SIZE, 91, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(30, 30, 30)
                .addComponent(jButton_Excel, javax.swing.GroupLayout.PREFERRED_SIZE, 78, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(73, 73, 73)
            ...
            .addGroup(jPanel24Layout.createSequentialGroup()
                ...
                .addGroup(jPanel24Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel24Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                        .addComponent(jButton_Excel, javax.swing.GroupLayout.PREFERRED_SIZE, 25, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addComponent(jButton_PDF, javax.swing.GroupLayout.PREFERRED_SIZE, 25, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addComponent(jButton_Reset, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 0, Short.MAX_VALUE)
                    .addGroup(jPanel24Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                        .addComponent(jComboBox_HienSanPham, javax.swing.GroupLayout.PREFERRED_SIZE, 34, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jTable_ThongKeChiTiet.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Mã sản phẩm", "Số lượng", "Ngày", "Tổng tiền"
            }
        ) {
    ...
    private void jButton_XacNhanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_XacNhanActionPerformed
        ...
        try {
            loadData(buss.thongkeTopSanpham(n1, n2));
    ...
    private void jButton_TimActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_TimActionPerformed
          ...
          try {
            loadData(buss.findMaspTopSP(Integer.parseInt(jTextField_TimKiem.getText())));
        } catch (SQLException ex) {
            Logger.getLogger(THongKePhieuNhap.class.getName()).log(Level.SEVERE, null, ex);
        }
...
SimpleDateFormat dateFormat = new SimpleDateFormat("yyyy-MM-dd");
        ...
        int i = jComboBox_HienSanPham.getSelectedIndex();
        if(i==0){
    try {
        loadData();
    } catch (SQLException ex) {
        Logger.getLogger(ThongKeSP.class.getName()).log(Level.SEVERE, null, ex);
             ...
             try {
        loadData(buss.thongkeTopSanpham5(n1, n2));
    } catch (SQLException ex) {
        Logger.getLogger(ThongKeSP.class.getName()).log(Level.SEVERE, null, ex);
    }
        }
...
private static void addEmptyLine(Paragraph paragraph, int number) {
    ...
    private void jButton_PDFActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_PDFActionPerformed
        ...
        try {
            int i = jComboBox_HienSanPham.getSelectedIndex();
        if(i==0)
            xuatfilePDF( buss.thongkeTopSanpham(n1, n2), n1, n2);
        else{
            xuatfilePDF( buss.thongkeTopSanpham5(n1, n2), n1, n2);
...
public void xuatfilePDF(ArrayList<top_sanpham> ds,String n1, String n2){
        try {
            Document document = new Document();
            PdfWriter.getInstance(document, new FileOutputStream("C:\\Users\\Nguyen\\Desktop\\BaoCaoSanPham.pdf"));
            document.open();
        ...
        Paragraph preface1 = new Paragraph("THỐNG KÊ TOP SẢN PHẨM", font1);
...
//        int i = 1;
        for (top_sanpham x : ds) {
            c1 = new PdfPCell(new Phrase(x.getSanphamID()));
            c1.setHorizontalAlignment(Element.ALIGN_CENTER);
             table.addCell(c1);
//             i++;
            ...
            c1.setHorizontalAlignment(Element.ALIGN_CENTER);
             table.addCell(c1);
            c1 = new PdfPCell(new Phrase(x.getNgay(),font));
            c1.setHorizontalAlignment(Element.ALIGN_CENTER);
             table.addCell(c1);
            c1 = new PdfPCell(new Phrase(x.getThanhtien()));
            c1.setHorizontalAlignment(Element.ALIGN_CENTER);
             table.addCell(c1);
...
//             table.addCell(x.getTongtien());
        ...
        preface2.add(new Paragraph("Số lượng: " + jTextField2.getText()+"",font));
...
//            addContent(document);
    ...
    private javax.swing.JComboBox<String> jComboBox_HienSanPham;
