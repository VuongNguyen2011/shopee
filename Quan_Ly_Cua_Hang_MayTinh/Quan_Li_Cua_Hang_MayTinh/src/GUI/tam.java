 ...
 * @author Nguyen
 */
public class tam extends javax.swing.JFrame {

    /**
     * Creates new form tam
     */
    public tam() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(tam.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
