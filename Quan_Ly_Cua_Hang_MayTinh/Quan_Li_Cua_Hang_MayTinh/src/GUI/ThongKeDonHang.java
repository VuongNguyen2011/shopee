...
public class ThongKeDonHang extends javax.swing.JFrame {
    ...
    public ThongKeDonHang() throws SQLException {
        initComponents();
        buss = new Buss();
...
//            vctData.add(hd.getNhanvienID());
    ...
    private void initComponents() {
        ...
        jTextField_TimKiem2 = new javax.swing.JTextField();
        ...
        jLabel12.setText("Thống kê doanh thu đơn hàng ");
        ...
        jTextField_TimKiem1.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        jTextField_TimKiem1.setHorizontalAlignment(javax.swing.JTextField.LEFT);

        jTextField_TimKiem2.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        jTextField_TimKiem2.setHorizontalAlignment(javax.swing.JTextField.LEFT);
        ...
        jPanel24Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel24Layout.createSequentialGroup()
                ...
                .addComponent(jTextField_TimKiem1, javax.swing.GroupLayout.PREFERRED_SIZE, 184, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGroup(jPanel24Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel24Layout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addComponent(jTextField_TimKiem2, javax.swing.GroupLayout.PREFERRED_SIZE, 184, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(jPanel24Layout.createSequentialGroup()
                        .addGap(18, 18, 18)
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel24Layout.createSequentialGroup()
                .addGroup(jPanel24Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel24Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                        ...
                        .addComponent(jTextField_TimKiem2, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addComponent(jButton_XacNhan, javax.swing.GroupLayout.PREFERRED_SIZE, 26, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, 15, Short.MAX_VALUE)
                .addGroup(jPanel24Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel24Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                        .addComponent(jLabel18)
                        .addComponent(jLabel14, javax.swing.GroupLayout.PREFERRED_SIZE, 26, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addComponent(jTextField_TimKiem1, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    ...
                    .addComponent(jButton_Reset, javax.swing.GroupLayout.PREFERRED_SIZE, 0, Short.MAX_VALUE)))
        );
        ...
        if (jTable_ThongKeChiTiet.getColumnModel().getColumnCount() > 0) {
            jTable_ThongKeChiTiet.getColumnModel().getColumn(0).setResizable(false);
        }
    ...
    private void jButton_TimActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_TimActionPerformed
        ...
        try {
            loadData(buss.findMaHD(jTextField_TimKiem1.getText()));
...
//            Logger.getLogger(ThongKeDonHang.class.getName()).log(Level.SEVERE, null, ex);
    ...
    private void jButton_ResetActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_ResetActionPerformed
       ...
       jTextField_TimKiem2.setText("");
//       jTextField_HienThiA.setText("");
//       jTextField_TrenB.setText("");
       loadData();
    ...
    private void jButton_XacNhanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_XacNhanActionPerformed
        ...
        String g1 = jTextField_TimKiem.getText();
        String g2 = jTextField_TimKiem2.getText();
        ...
        if(!g1.trim().equalsIgnoreCase("")&& !g2.trim().equalsIgnoreCase("")&&!n2.trim().equalsIgnoreCase("")&&!n1.trim().equalsIgnoreCase("")) try {
            {loadData(buss.thongke4truong(g1, g2, n1, n2));
            return;}
        } catch (SQLException ex) {
            Logger.getLogger(ThongKeDonHang.class.getName()).log(Level.SEVERE, null, ex);
        }
        if(g1.trim().equalsIgnoreCase("")&& !g2.trim().equalsIgnoreCase("")&&!n2.trim().equalsIgnoreCase("")&&!n1.trim().equalsIgnoreCase("")) try {
            { loadData(buss.thongke3_vangG1_truong(g2, n1, n2));
            return;}
        } catch (SQLException ex) {
            Logger.getLogger(ThongKeDonHang.class.getName()).log(Level.SEVERE, null, ex);
        }
        if(!g1.trim().equalsIgnoreCase("")&& g2.trim().equalsIgnoreCase("")&&!n2.trim().equalsIgnoreCase("")&&!n1.trim().equalsIgnoreCase("")) try {
            {loadData(buss.thongke3_vangG2_truong(g1, n1, n2));
            return;}
        } catch (SQLException ex) {
            Logger.getLogger(ThongKeDonHang.class.getName()).log(Level.SEVERE, null, ex);
        }
        if(!g1.trim().equalsIgnoreCase("")&& !g2.trim().equalsIgnoreCase("")&&n2.trim().equalsIgnoreCase("")&&!n1.trim().equalsIgnoreCase(""))try {
            { loadData(buss.thongke3_vangN2_truong(g1, g2, n1));
            return;}
        } catch (SQLException ex) {
            Logger.getLogger(ThongKeDonHang.class.getName()).log(Level.SEVERE, null, ex);
        }
        ...
        if(g1.trim().equalsIgnoreCase("")&& g2.trim().equalsIgnoreCase("")&&!n2.trim().equalsIgnoreCase("")&&!n1.trim().equalsIgnoreCase("")) try {
            {loadData(buss.thongke2_vanggia_truong(n1, n2));
            return;}
        } catch (SQLException ex) {
            Logger.getLogger(ThongKeDonHang.class.getName()).log(Level.SEVERE, null, ex);
        }
        if(!g1.trim().equalsIgnoreCase("")&& !g2.trim().equalsIgnoreCase("")&&n2.trim().equalsIgnoreCase("")&&n1.trim().equalsIgnoreCase("")) try {
            {
             loadData(buss.thongke2_vangNgay_truong(g1, g2));
            return;
            }
        } catch (SQLException ex) {
            Logger.getLogger(ThongKeDonHang.class.getName()).log(Level.SEVERE, null, ex);
...
private static void addEmptyLine(Paragraph paragraph, int number) {
    ...
    private void jButton_PDFActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_PDFActionPerformed
        ...
        if(!g1.trim().equalsIgnoreCase("")&& !g2.trim().equalsIgnoreCase("")&&!n2.trim().equalsIgnoreCase("")&&!n1.trim().equalsIgnoreCase("")) try {
            {xuatfilePDF(buss.thongke4truong(g1, g2, n1, n2),n1,n2);
            return;}
        } catch (SQLException ex) {
            Logger.getLogger(ThongKeDonHang.class.getName()).log(Level.SEVERE, null, ex);
        }
        if(g1.trim().equalsIgnoreCase("")&& !g2.trim().equalsIgnoreCase("")&&!n2.trim().equalsIgnoreCase("")&&!n1.trim().equalsIgnoreCase("")) try {
            { xuatfilePDF(buss.thongke3_vangG1_truong(g2, n1, n2),n1,n2);
            return;}
        } catch (SQLException ex) {
            Logger.getLogger(ThongKeDonHang.class.getName()).log(Level.SEVERE, null, ex);
        }
        if(!g1.trim().equalsIgnoreCase("")&& g2.trim().equalsIgnoreCase("")&&!n2.trim().equalsIgnoreCase("")&&!n1.trim().equalsIgnoreCase("")) try {
            {xuatfilePDF(buss.thongke3_vangG2_truong(g1, n1, n2),n1,n2);
            return;}
        } catch (SQLException ex) {
            Logger.getLogger(ThongKeDonHang.class.getName()).log(Level.SEVERE, null, ex);
        }
        if(!g1.trim().equalsIgnoreCase("")&& !g2.trim().equalsIgnoreCase("")&&n2.trim().equalsIgnoreCase("")&&!n1.trim().equalsIgnoreCase(""))try {
            { xuatfilePDF(buss.thongke3_vangN2_truong(g1, g2, n1),n1,"");
            return;}
        } catch (SQLException ex) {
            Logger.getLogger(ThongKeDonHang.class.getName()).log(Level.SEVERE, null, ex);
        }
        if(!g1.trim().equalsIgnoreCase("")&& !g2.trim().equalsIgnoreCase("")&&!n2.trim().equalsIgnoreCase("")&&n1.trim().equalsIgnoreCase(""))try {
            {xuatfilePDF(buss.thongke3_vangN1(g1, g2, n2),"",n2);
            return;}
        } catch (SQLException ex) {
            Logger.getLogger(ThongKeDonHang.class.getName()).log(Level.SEVERE, null, ex);
        }
        if(g1.trim().equalsIgnoreCase("")&& g2.trim().equalsIgnoreCase("")&&!n2.trim().equalsIgnoreCase("")&&!n1.trim().equalsIgnoreCase("")) try {
            {xuatfilePDF(buss.thongke2_vanggia_truong(n1, n2),n1,n2);
            return;}
        } catch (SQLException ex) {
            Logger.getLogger(ThongKeDonHang.class.getName()).log(Level.SEVERE, null, ex);
        }
        if(!g1.trim().equalsIgnoreCase("")&& !g2.trim().equalsIgnoreCase("")&&n2.trim().equalsIgnoreCase("")&&n1.trim().equalsIgnoreCase("")) try {
            {
             xuatfilePDF(buss.thongke2_vangNgay_truong(g1, g2),"","");
            return;
            }
        } catch (SQLException ex) {
            Logger.getLogger(ThongKeDonHang.class.getName()).log(Level.SEVERE, null, ex);
    ...
    private void jButton_ExcelActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_ExcelActionPerformed
        ...
        try {
            buss.xuatExcel_HoaDon(buss.getDshd());
    ...
    public void xuatfilePDF(ArrayList<HoaDon> ds,String n1, String n2){
        try {
            Document document = new Document();
            PdfWriter.getInstance(document, new FileOutputStream("C:\\Users\\Nguyen\\Desktop\\BaoCaoHoaDon.pdf"));
            document.open();
        ...
        Paragraph preface1 = new Paragraph("THỐNG KÊ HÓA ĐƠN", font1);
...
////                redFont));
        ...
        c1 = new PdfPCell(new Phrase("Mã đơn",font));
        c1.setHorizontalAlignment(Element.ALIGN_CENTER);
        table.addCell(c1);
...
//        table.addCell(c1);
        ...
        for (HoaDon x : ds) {
            ...
            c1.setHorizontalAlignment(Element.ALIGN_CENTER);
             table.addCell(c1);
             i++;
            c1 = new PdfPCell(new Phrase(x.getHoadonID()+""));
            c1.setHorizontalAlignment(Element.ALIGN_CENTER);
             table.addCell(c1);
            c1 = new PdfPCell(new Phrase(x.getNgaylap(),font));
            c1.setHorizontalAlignment(Element.ALIGN_CENTER);
             table.addCell(c1);
...
//             table.addCell(x.getTongtien());
        ...
        preface2.add(new Paragraph(
                "Tổng tiền: " + jTextField3.getText(),font));
...
//            addContent(document);
    ...
    private javax.swing.JTextField jTextField_TimKiem2;
