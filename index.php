                                    ...
                                    ?>
                                        <li class="category-item">
                                            <div class="checkbox category">
                                                <input style="width: unset; height: unset;" type="checkbox" name="brand[]" value=<?php echo $row1['brandID']  ?>>
                ...
                <div id="content">
                    ...
                    ?>
                        <li class="pagination-item">
                            <span id="trang_0" onclick='phantrang(0, <?php echo $catNose ?>,<?php echo $sotrang ?>)' class="pagination-item-link">
                        ...
                        for($i = 1;$i<=$sotrang;$i++){
                            ...
                            <span id='trang_$i' onclick='phantrang($i,$catNose,$sotrang)' style='cursor: pointer;' class='pagination-item-link'>$i
                            </span>
                        </li>";
                        }
                        ...
                        <li class="pagination-item">
                            ...
                            <span id="trang_10" onclick='phantrang(10,<?php echo $catNose ?>,<?php echo $sotrang ?>)' class="pagination-item-link">
