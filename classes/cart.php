...
class cart
{
    ...
    public function add_oder($cartID,$productID,$productName,$price,$quatity,$colorID,$cost,$qtyPro)
    {
        ...
        $cost = mysqli_real_escape_string($this->db->link, $cost);
        $qtyPro = mysqli_real_escape_string($this->db->link, $qtyPro);
        ...
        // $sID = session_id();
            ...
            $query1 = "UPDATE `tbl_product` SET `qty`='$qtyPro' WHERE productID = '$productID'";
